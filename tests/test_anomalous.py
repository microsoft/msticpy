...
class TestAnomalous(unittest.TestCase):
    ...
    def test_score_sessions(self):
        actual = anomalous.score_sessions(data=self.data1, session_column='session', window_length=3)
        ...
        actual = anomalous.score_sessions(data=self.data2, session_column='session', window_length=3)
        window = actual['rarest_window3'].iloc[0]
        cmd = window[0]
        self.assertTrue(isinstance(window, list))
        ...
        actual = anomalous.score_sessions(data=self.data3, session_column='session', window_length=3)
        window = actual['rarest_window3'].iloc[0]
        cmd = window[0]
        self.assertTrue(isinstance(window, list))
        self.assertTrue('name' in dir(cmd))
        ...
        actual = anomalous.score_sessions(data=self.data3, session_column='session', window_length=5)
