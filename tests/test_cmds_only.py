...
class TestCmdsOnly(unittest.TestCase):
    ...
    def setUp(self):
        ...
        trans_probs = {
            ...
            '##UNK##': {'Set-User': 0.3333333333333333, '##END##': 0.3333333333333333, '##UNK##': 0.3333333333333333}
        }
    ...
    def test_compute_counts(self):
        ...
        seq2_expected = {START_TOKEN: {END_TOKEN: 2, UNK_TOKEN: 1}, UNK_TOKEN: {END_TOKEN: 1, UNK_TOKEN: 1}}
        seq1_actual, seq2_actual = cmds_only.compute_counts(
            sessions=sessions, start_token=START_TOKEN,
            end_token=END_TOKEN,
            unk_token=UNK_TOKEN)
