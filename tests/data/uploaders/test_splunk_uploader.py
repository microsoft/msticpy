...
def test_df_failure(sp_upload):
    ...
    with pytest.raises(MsticpyUserError):
        sp_upload.upload_df("123", "test_upload", "test_upload")
...
def test_folder_upload(sp_upload):
    ...
    sp_upload.upload_folder(data_folder, "test_upload", "test_upload")


def test_folder_upload_no_name(sp_upload):
    """Test folder upload with no name specified."""
    data_folder = Path(_TEST_DATA).joinpath("uploader")
    sp_upload.upload_folder(data_folder, "test_upload")
