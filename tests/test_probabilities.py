...
class TestProbabilities(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.data1['cmd_param_counts'] = StateMatrix({UNK_TOKEN: {UNK_TOKEN: 1}}, UNK_TOKEN)
        self.data1['value_counts'] = StateMatrix({UNK_TOKEN: 1}, UNK_TOKEN)
        self.data1['param_value_counts'] = StateMatrix({UNK_TOKEN: {UNK_TOKEN: 1}}, UNK_TOKEN)
        ...
        self.data1['param_cond_cmd_probs'] = StateMatrix({UNK_TOKEN: {UNK_TOKEN: 1}}, UNK_TOKEN)
        self.data1['value_probs'] = StateMatrix({UNK_TOKEN: 1}, UNK_TOKEN)
        self.data1['value_cond_param_probs'] = StateMatrix({UNK_TOKEN: {UNK_TOKEN: 1}}, UNK_TOKEN)

        # populate data2
        self.data2['sessions'] = [[]]
        self.data2['seq1_counts'] = StateMatrix({UNK_TOKEN: 4, START_TOKEN: 3, END_TOKEN: 3}, UNK_TOKEN)
        ...
        self.data2['param_value_counts'] = StateMatrix({UNK_TOKEN: {UNK_TOKEN: 1}}, UNK_TOKEN)
        self.data2['prior_probs'] = StateMatrix({START_TOKEN: 0.3, END_TOKEN: 0.3, UNK_TOKEN: 0.4}, UNK_TOKEN)
        self.data2['trans_probs'] = StateMatrix({
            START_TOKEN: {END_TOKEN: 0.6666666666666666, UNK_TOKEN: 0.3333333333333333},
        ...
        self.data2['value_cond_param_probs'] = StateMatrix({UNK_TOKEN: {UNK_TOKEN: 1}}, UNK_TOKEN)
        ...
        self.data3['seq1_counts'] = StateMatrix({UNK_TOKEN: 6, START_TOKEN: 4, END_TOKEN: 4, cmd: 8}, UNK_TOKEN)
        ...
        self.data3['prior_probs'] = StateMatrix({
            START_TOKEN: 0.18181818181818182, END_TOKEN: 0.18181818181818182, UNK_TOKEN: 0.2727272727272727,
        ...
        self.data3['param_probs'] = StateMatrix({
            UNK_TOKEN: 0.4444444444444444, 'Identity': 0.3333333333333333, 'City': 0.2222222222222222
        }, UNK_TOKEN)
        self.data3['param_cond_cmd_probs'] = StateMatrix({
            START_TOKEN: {UNK_TOKEN: 1.0},
            END_TOKEN: {UNK_TOKEN: 1.0},
            UNK_TOKEN: {UNK_TOKEN: 1.0},
            cmd: {'City': 0.3333333333333333, 'Identity': 0.5, UNK_TOKEN: 0.16666666666666666}
        }, UNK_TOKEN)
        self.data3['value_probs'] = StateMatrix({
            'york': 0.25, 'blah': 0.375, UNK_TOKEN: 0.375
        }, UNK_TOKEN)
    ...
    def test_compute_values_probs(self):
        ...
        self.assertDictEqual(value_cond_param_actual, self.data1['value_cond_param_probs'])
        ...
        self.assertDictEqual(value_cond_param_actual, self.data2['value_cond_param_probs'])
        ...
        self.assertDictEqual(value_cond_param_actual, self.data3['value_cond_param_probs'])
