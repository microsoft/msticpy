...
class TestDataStructures(unittest.TestCase):
    ...
    def test_state_matrix(self):
        ...
        states = {'haha': {'hehe': 1, UNK_TOKEN: 4}, UNK_TOKEN: {UNK_TOKEN: 6, 'lol': 78}}
        states_matrix = StateMatrix(states, UNK_TOKEN)
        self.assertEqual(states_matrix['kidhf']['kfji'], states_matrix[UNK_TOKEN][UNK_TOKEN])
        self.assertEqual(states_matrix['haha']['kjdff'], states_matrix['haha'][UNK_TOKEN])
