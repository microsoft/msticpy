...
from ..common.pkg_config import register_reload_refresh_cb
...
class Lookup:
    ...
    def __init__(self, providers: Optional[List[str]] = None, **kwargs):
        ...
        # register reload_providers to be called if settings are refreshed
        register_reload_refresh_cb(self.reload_providers())
    ...
    def _load_providers(self, **kwargs):
        ...
        for provider_entry, settings in prov_settings.items():
            ...
            try:
                ...
                #     - path1...
                # definition:
                #   path: path_to_file (can be global)
                #   name: entry_in_file
                # provider_class = create_dyn_prov_class(path, name)
