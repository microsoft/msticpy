...
_OAUTH_URL = "https://login.windows.net/{tenantId}/oauth2/token"


@export
class MDATPDriver(DriverBase):
    ...
    _DEF_API_ROOT = "https://api.securitycenter.windows.com/"
    _DEF_API_VER = "api"
