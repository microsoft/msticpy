...
def compute_counts(sessions: List[List[str]], start_token: str = '##START##', end_token: str = '##END##',
                   unk_token: str = '##UNK##') -> Tuple[StateMatrix, StateMatrix]:
    """
    ...
    """
    assert start_token != end_token != unk_token, 'start_token, end_token, unk_tokens should all be set to something ' \
                                                  'different'
...
def compute_likelihood_window(window: List[str], prior_probs: Union[StateMatrix, dict],
                              trans_probs: Union[StateMatrix, dict], use_start_token: bool,
                              use_end_token: bool, start_token: str = None, end_token: str = None) \
        -> float:
    """
...
def compute_likelihood_windows_in_session(session: List[str], prior_probs: Union[StateMatrix, dict],
                                          trans_probs: Union[StateMatrix, dict], window_len: int,
...
def rarest_window_session(session: List[str], prior_probs: Union[StateMatrix, dict],
                          trans_probs: Union[StateMatrix, dict], window_len: int,
                          use_start_end_tokens: bool, start_token: str, end_token: str,
                          use_geo_mean: bool = False) -> Tuple[List[str], float]:
    """
