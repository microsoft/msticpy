...
def compute_cmds_probs(seq1_counts: Union[StateMatrix, dict], seq2_counts: Union[StateMatrix, dict],
    ...
    for prev, currents in seq2_counts.items():
        for current in currents:
            trans_probs[prev][current] = seq2_counts[prev][current] / sum(seq2_counts[prev].values())
...
def compute_params_probs(param_counts: Union[StateMatrix, dict], cmd_param_counts: Union[StateMatrix, dict],
                         unk_token: str = '##UNK##') -> Tuple[StateMatrix, StateMatrix]:
    """
...
def compute_values_probs(value_counts: Union[StateMatrix, dict], param_value_counts: Union[StateMatrix, dict],
                         unk_token: str = '##UNK##') -> Tuple[StateMatrix, StateMatrix]:
    """
    ...
    value_cond_param_probs = StateMatrix(states=value_cond_param_probs, unk_token=unk_token)
