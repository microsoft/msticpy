...
MDATP         list_connections            Retrieves list of network connections                                                                                               end (datetime), start (datetime)                                    DeviceNetworkEvents
...
MDATP         process_for_hash            Lists all processes created for a file hash                                                                                         end (datetime), file_hash (str), start (datetime)                   DeviceProcessEvents
...
MDATP         user_files                  Lists all files created by a user                                                                                                   account_name (str), end (datetime), start (datetime)                DeviceFileEvents
MDATP         user_logons                 Lists all user logons by user                                                                                                       account_name (str), end (datetime), start (datetime)                DeviceLogonEvents
MDATP         user_network                Lists all network connections associated with a user                                                                                account_name (str), end (datetime), start (datetime)                DeviceNetworkEvents
MDATP         user_processes              Lists all processes created by a user                                                                                               account_name (str), end (datetime), start (datetime)                DeviceProcessEvents
